...
class ProveedoresFragment : BaseBottomNavFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = Po04BodegaProveedoresOpBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnInsumos.setOnClickListener { (requireActivity() as com.project.avisensandroid.ui.MainActivity).mostrarFragment(BodegaFragment()) }
    }
