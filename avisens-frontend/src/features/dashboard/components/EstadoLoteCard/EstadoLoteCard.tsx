...
const EstadoLoteCard = ({ galpon }: { galpon: Galpon }) => (
  <Card id="dash-section-estado">
    <CardTitle action={<button className="mini-btn"><IcRefresh size={12} /></button>}>
      Estado del lote
    </CardTitle>
    <div className="dash-rows">
      <Row label="Edad"       value={`${galpon.dia} días`} />
    ...
    <div className="dash-card-foot">
      <div className="dash-foot-row">
        <span className="dash-foot-label">Tendencia bienestar (10 días)</span>
