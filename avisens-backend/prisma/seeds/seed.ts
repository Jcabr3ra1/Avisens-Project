...
const PREGUNTAS_CHATBOT = [
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 1,
    texto: 'Para darte una cotización necesitamos algunos datos tuyos y de tu granja.\n\n¿Autorizas su tratamiento? Puedes consultar nuestra política en https://avisens-project-production.up.railway.app/privacidad',
    tipo: 'si_no',
    opciones: ['Sí', 'No'],
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 3,
    texto: '¿Cuál es tu número de documento?',
    tipo: 'texto_libre',
    opciones: null,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 7,
    texto: '¿En qué municipio está ubicada?',
    tipo: 'texto_libre',
    opciones: null,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 8,
    texto: '¿Cuántas aves manejas por ciclo?',
    tipo: 'opcion_unica',
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 9,
    texto: '¿Ya tienes el galpón construido?',
    tipo: 'opcion_unica',
    opciones: [
      'Sí, está construido y se encuentra en buenas condiciones',
      'Sí, pero necesita adecuaciones',
      'No, aún no lo construyo',
    ],
    campo_prospecto: null,
    omitir_si_canal: null,
    puntua: true,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 10,
    texto: '¿Cuántos metros cuadrados tiene el galpón?',
    tipo: 'numero',
    opciones: null,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 11,
    texto: '¿Qué tipo de suministro eléctrico tienes en la granja?',
    tipo: 'opcion_unica',
    opciones: [
      'Eléctrico estable',
      'Eléctrico con cortes frecuentes',
      'Planta eléctrica',
      'No tengo energía en el galpón',
    ],
    campo_prospecto: null,
    omitir_si_canal: null,
    puntua: true,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 12,
    texto: '¿Cuántos metros cuadrados tiene la granja en total?',
    tipo: 'numero',
    opciones: null,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 13,
    texto: '¿Tienes conexión a internet en la granja?',
    tipo: 'opcion_unica',
...

  {
    ...
    bloque: 'A',
    orden: 14,
    texto: '¿Cuál es tu rol en la granja?',
    tipo: 'opcion_unica',
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 15,
    texto: '¿Qué tipo de producción manejas?',
    tipo: 'opcion_unica',
  ...
  },
  {
    ...
    orden: 16,
    texto:
      '¿Has perdido aves por problemas de temperatura, humedad o ventilación?',
    tipo: 'opcion_unica',
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 17,
    texto: '¿Eres tú quien decide las compras de la granja?',
    tipo: 'si_no',
    opciones: ['Sí', 'No'],
    campo_prospecto: null,
    omitir_si_canal: null,
  ...
  },
  {
    ...
    bloque: 'A',
    orden: 18,
    texto: '¿Cómo preferirías adquirir el sistema?',
    tipo: 'opcion_unica',
    opciones: [
      'Compra directa',
      'Suscripción',
